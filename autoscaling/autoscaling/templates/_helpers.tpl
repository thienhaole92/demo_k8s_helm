...
{{ include "autoscaling.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "autoscaling.selectorLabels" -}}
...
*/}}
{{- define "autoscaling.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "autoscaling.fullname" .) .Values.serviceAccount.name }}
{{- else }}
